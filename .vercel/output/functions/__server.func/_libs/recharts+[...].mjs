...
var getCartesianPosition = (options) => {
	...
	if (position === "insideLeft") return _objectSpread$33({
		x: middleX + horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalStart,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideRight") return _objectSpread$33({
		x: middleX + midHeightWidth - horizontalOffset,
		y: y + height / 2,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: "middle"
	}, sizeAttrs);
	if (position === "insideTop") return _objectSpread$33({
		x: upperX + upperWidth / 2,
		y: y + verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottom") return _objectSpread$33({
		x: lowerX + lowerWidth / 2,
		y: y + height - verticalOffset,
		horizontalAnchor: "middle",
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideTopLeft") return _objectSpread$33({
		x: upperX + horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideTopRight") return _objectSpread$33({
		x: upperX + upperWidth - horizontalOffset,
		y: y + verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalStart
	}, sizeAttrs);
	if (position === "insideBottomLeft") return _objectSpread$33({
		x: lowerX + horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalStart,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (position === "insideBottomRight") return _objectSpread$33({
		x: lowerX + lowerWidth - horizontalOffset,
		y: y + height - verticalOffset,
		horizontalAnchor: horizontalEnd,
		verticalAnchor: verticalEnd
	}, sizeAttrs);
	if (!!position && typeof position === "object" && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) return _objectSpread$33({
		x: x + getPercentValue(position.x, midHeightWidth),
		y: y + getPercentValue(position.y, height),
		horizontalAnchor: "end",
		verticalAnchor: "end"
	}, sizeAttrs);
	return _objectSpread$33({
		x: centerX,
		y: y + height / 2,
		horizontalAnchor: "middle",
		verticalAnchor: "middle"
...
function resolveDefaultProps(realProps, defaultProps) {
	var resolvedProps = _objectSpread$32({}, realProps);
	var dp = defaultProps;
	...
	if (legendSettings && legendSize) {
		...
		if (position != null) {
			if (isOutsidePosition(position)) {
				if (position === "top" && isNumber(offset.top)) return _objectSpread$31(_objectSpread$31({}, offset), {}, { top: offset.top + (boxHeight || 0) + legendOffset });
				if (position === "bottom" && isNumber(offset.bottom)) return _objectSpread$31(_objectSpread$31({}, offset), {}, { bottom: offset.bottom + (boxHeight || 0) + legendOffset });
				if (position === "left" && isNumber(offset.left)) return _objectSpread$31(_objectSpread$31({}, offset), {}, { left: offset.left + (boxWidth || 0) + legendOffset });
				if (position === "right" && isNumber(offset.right)) return _objectSpread$31(_objectSpread$31({}, offset), {}, { right: offset.right + (boxWidth || 0) + legendOffset });
			}
			return offset;
		}
		if ((layout === "vertical" || layout === "horizontal" && verticalAlign === "middle") && align !== "center" && isNumber(offset[align])) return _objectSpread$31(_objectSpread$31({}, offset), {}, { [align]: offset[align] + (boxWidth || 0) });
		if ((layout === "horizontal" || layout === "vertical" && align === "center") && verticalAlign !== "middle" && isNumber(offset[verticalAlign])) return _objectSpread$31(_objectSpread$31({}, offset), {}, { [verticalAlign]: offset[verticalAlign] + (boxHeight || 0) });
	}
	return offset;
};
...
function getTooltipEntry(_ref4) {
	...
	return _objectSpread$31(_objectSpread$31({}, tooltipEntrySettings), {}, {
		dataKey,
		payload,
		value,
		name
...
var selectChartOffsetInternal = createSelector([
	...
	var offset = _objectSpread$30(_objectSpread$30({}, {
	...
	return _objectSpread$30(_objectSpread$30({ brushBottom }, offset), {}, {
...
var DefaultTooltipContent = (props) => {
	...
	var renderContent = () => {
		if (payload && payload.length) {
			...
			var items = lodashLikeSortBy(payload, itemSorter).map((entry, i) => {
				...
				var finalItemStyle = _objectSpread$28(_objectSpread$28({}, defaultDefaultTooltipContentProps.itemStyle), {}, { color: entry.color || defaultDefaultTooltipContentProps.itemStyle.color }, itemStyle);
	...
	var finalStyle = _objectSpread$28(_objectSpread$28({}, defaultDefaultTooltipContentProps.contentStyle), contentStyle);
...
function TooltipBoundingBoxImpl(props) {
	...
	var outerStyle = _objectSpread$27(_objectSpread$27({}, props.hasPortalFromProps ? {} : _objectSpread$27(_objectSpread$27({ transition: resolveTransitionProperty({
...
var getPath$1 = (_ref) => {
	...
	if (Array.isArray(baseLine)) {
		var _lineFunction;
		var areaPoints = points.map((entry, index) => _objectSpread$26(_objectSpread$26({}, entry), {}, { base: baseLine[index] }));
...
var Cross = (_ref) => {
	var _ref$x = _ref.x, x = _ref$x === void 0 ? 0 : _ref$x, _ref$y = _ref.y, y = _ref$y === void 0 ? 0 : _ref$y, _ref$top = _ref.top, top = _ref$top === void 0 ? 0 : _ref$top, _ref$left = _ref.left, left = _ref$left === void 0 ? 0 : _ref$left, _ref$width = _ref.width, width = _ref$width === void 0 ? 0 : _ref$width, _ref$height = _ref.height, height = _ref$height === void 0 ? 0 : _ref$height, className = _ref.className, rest = _objectWithoutProperties$16(_ref, _excluded$16);
	var props = _objectSpread$25({
		x,
		y,
		top,
		left,
...
var RechartsAnimation = class {
	...
	*/
	...
	constructor(param) {
		...
		_defineProperty$27(this, "state", INIT);
...
*/
var _excluded$15 = ["radius"];
var _excluded2$8 = ["radius"];
...
var Rectangle = (rectangleProps) => {
	...
	if (!isUpdateAnimationActive) {
		...
		var otherPathProps = _objectWithoutProperties$15(_svgPropertiesAndEven, _excluded$15);
	...
	return /*#__PURE__*/ import_react.createElement(JavascriptAnimate, {
		...
		var otherPathProps = _objectWithoutProperties$15(_svgPropertiesAndEven2, _excluded2$8);
		return /*#__PURE__*/ import_react.createElement("path", _extends$14({}, otherPathProps, {
			radius: typeof radius === "number" ? radius : void 0,
			className: layerClass,
		...
		var listener = (incomingSyncId, action, emitter) => {
			...
			if (syncMethod === "index") {
				...
				if (viewBox && action !== null && action !== void 0 && (_action$payload = action.payload) !== null && _action$payload !== void 0 && _action$payload.coordinate && action.payload.sourceViewBox) {
					var _action$payload$coord = action.payload.coordinate, _x = _action$payload$coord.x, _y = _action$payload$coord.y, otherCoordinateProps = _objectWithoutProperties$14(_action$payload$coord, _excluded$14);
...
var Text = /*#__PURE__*/ (0, import_react.forwardRef)((outsideProps, ref) => {
	...
	var dx = props.dx, dy = props.dy, angle = props.angle, className = props.className, breakAll = props.breakAll, textProps = _objectWithoutProperties$13(props, _excluded2$7);
...
var _excluded$12 = ["labelRef"];
var _excluded2$6 = ["content"];
...
function Label(outerProps) {
	...
	if (isPolar(viewBox)) {
		...
		positionAttrs = _objectSpread$11(_objectSpread$11({
			x: cartesianResult.x,
			y: cartesianResult.y,
...
var parseLabel = (label, viewBox, labelRef) => {
	...
	if (/*#__PURE__*/ (0, import_react.isValidElement)(label)) {
		if (label.type === Label) return /*#__PURE__*/ (0, import_react.cloneElement)(label, _objectSpread$11({ key: "label-implicit" }, commonProps));
...
function LabelList(_ref) {
	var _ref$valueAccessor = _ref.valueAccessor, valueAccessor = _ref$valueAccessor === void 0 ? defaultAccessor : _ref$valueAccessor, restProps = _objectWithoutProperties$11(_ref, _excluded$11), dataKey = restProps.dataKey;
	restProps.clockWise;
	var id = restProps.id, textBreakAll = restProps.textBreakAll, zIndex = restProps.zIndex, others = _objectWithoutProperties$11(restProps, _excluded2$5);
...
var CartesianAxisComponent = /*#__PURE__*/ (0, import_react.forwardRef)((props, ref) => {
	var axisLine = props.axisLine, width = props.width, height = props.height, className = props.className, hide = props.hide, ticks = props.ticks, axisType = props.axisType, axisId = props.axisId, rest = _objectWithoutProperties$10(props, _excluded$10);
...
function LineItem(_ref) {
	...
	if (/*#__PURE__*/ import_react.isValidElement(option)) lineItem = /*#__PURE__*/ import_react.cloneElement(option, lineItemProps);
		...
		var x1 = lineItemProps.x1, y1 = lineItemProps.y1, x2 = lineItemProps.x2, y2 = lineItemProps.y2, key = lineItemProps.key, _ref2 = (_svgPropertiesNoEvent = svgPropertiesNoEvents(_objectWithoutProperties$9(lineItemProps, _excluded$9))) !== null && _svgPropertiesNoEvent !== void 0 ? _svgPropertiesNoEvent : {};
		_ref2.offset;
		var restOfFilteredProps = _objectWithoutProperties$9(_ref2, _excluded2$4);
...
function HorizontalGridLines(props) {
	...
	props.xAxisId;
	props.yAxisId;
	var otherLineItemProps = _objectWithoutProperties$9(props, _excluded3$3);
...
function VerticalGridLines(props) {
	...
	props.xAxisId;
	props.yAxisId;
	var otherLineItemProps = _objectWithoutProperties$9(props, _excluded4$1);
...
//#endregion
export { CartesianGrid as a, Bar as i, YAxis as n, Tooltip as o, XAxis as r, ResponsiveContainer as s, BarChart as t };
